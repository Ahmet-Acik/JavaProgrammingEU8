...
public class ReferenceTypeCastings {
    ...
    public static void main(String[] args) {
        ...
        //  ( (Tester)employee ).unitTest(); unitTest is done by developer.

        //  ( (Developer)employee ).unitTest(); there is no relationship between tester and developer
